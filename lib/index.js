...
/**
 * Estimated list prices in CNY (¥ per 1M tokens): input (cache miss),
 * cached input, output. Derived from the public DeepSeek USD list prices at
 * ~7.2 CNY/USD; estimates only — the billboard carries an explicit note.
 */
const DEFAULT_PRICE = { in: 2, cache: 0.2, out: 3 }
const PRICING = {
  ...
  'deepseek-v4-flash': DEFAULT_PRICE,
  'deepseek-v4-pro': DEFAULT_PRICE,
  'deepseek-v4-flash-vision-exp': DEFAULT_PRICE,
}
