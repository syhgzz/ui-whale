  ...
  factory: (require) => {
    ...
    function WhaleMark() {
      return el('svg', { viewBox: '0 0 36 28', className: 'whl-mark', 'aria-hidden': true },
        el('path', { d: 'M 33 13 C 33 6 26 2 17 2 C 8 2 3 6 3 13 C 3 20 9 25 17 25 C 26 25 33 20 33 13 Z', fill: '#2f6699' }),
        el('path', { d: 'M 7 12 C 4 8 1 6 0 6 C 1 10 2 14 4 16 C 2 18 1 22 0 25 C 4 24 7 19 7 13 Z', fill: '#2a5f92' }),
        el('circle', { cx: 25, cy: 11, r: 2.6, fill: '#05121f' }),
        el('circle', { cx: 26.8, cy: 10.2, r: 0.9, fill: '#ffffff' }),
        el('path', { d: 'M 20 16 Q 24 19.5 28 16', stroke: '#061c33', strokeWidth: 1.8, fill: 'none', strokeLinecap: 'round' }),
      )
    }

    // Chubby cartoon whale: round head on the right, fat belly, short rounded
    // flukes on the left. Deep-blue palette (no light blues).
    const BODY = 'M 136 46 C 136 26 116 13 92 14 C 66 15 42 27 31 45 C 26 54 26 68 32 77 C 47 89 78 92 104 84 C 126 78 136 64 136 46 Z'
    const FLUKES = 'M 36 60 C 32 51 24 45 13 44 C 17 51 20 56 23 60 C 20 64 17 69 13 76 C 24 74 31 67 36 60 Z'
      ...
      return el('svg', { viewBox: '0 0 150 100', width: 150, height: 100, className: 'whl-whale-svg', 'aria-hidden': true },
        el('defs', null,
          el('linearGradient', { id: 'whlBodyGrad', x1: '0', y1: '0', x2: '0', y2: '1' },
            el('stop', { offset: '0%', stopColor: '#2f6699' }),
            el('stop', { offset: '55%', stopColor: '#1f4d7e' }),
            el('stop', { offset: '100%', stopColor: '#123a61' }),
          ),
        ...
        el('g', { className: 'whl-tail' },
          el('path', { d: FLUKES, fill: '#2a5f92', stroke: '#061c33', strokeWidth: 3, strokeLinejoin: 'round', strokeLinecap: 'round' }),
        ),
        el('g', null,
          el('path', { d: BODY, fill: 'url(#whlBodyGrad)', stroke: '#061c33', strokeWidth: 3, strokeLinejoin: 'round' }),
          el('g', { clipPath: 'url(#whlBodyClip)' },
            el('ellipse', { cx: 78, cy: 82, rx: 56, ry: 16, fill: '#3d7bad' }),
            el('path', { d: 'M 100 80 Q 95 86 88 86.5', stroke: '#25537f', strokeWidth: 1.6, fill: 'none', strokeLinecap: 'round' }),
            el('path', { d: 'M 86 82 Q 81 87 74 87.5', stroke: '#25537f', strokeWidth: 1.6, fill: 'none', strokeLinecap: 'round' }),
            el('path', { d: 'M 72 83 Q 67 87 61 87', stroke: '#25537f', strokeWidth: 1.6, fill: 'none', strokeLinecap: 'round' }),
          ),
          el('path', { d: 'M 86 72 C 80 82 68 88 58 86 C 62 79 66 73 70 69 C 75 68 81 69 86 72 Z', fill: '#2a5f92', stroke: '#061c33', strokeWidth: 2.2, strokeLinejoin: 'round' }),
          el('path', { d: 'M 122 26 Q 130 32 132 42', stroke: 'rgba(255, 255, 255, 0.2)', strokeWidth: 3.4, fill: 'none', strokeLinecap: 'round' }),
          el('path', { d: 'M 89 20 Q 94 15 99 19', stroke: '#061c33', strokeWidth: 2.6, fill: 'none', strokeLinecap: 'round' }),
          el('ellipse', { cx: 94, cy: 19.5, rx: 3.2, ry: 1.6, fill: '#061c33' }),
          el('circle', { cx: 110, cy: 44, r: 8.5, fill: '#05121f' }),
          el('circle', { cx: 115, cy: 38.5, r: 3, fill: '#ffffff' }),
          el('circle', { cx: 108.5, cy: 46, r: 1.4, fill: '#ffffff', opacity: 0.85 }),
          el('path', { d: 'M 104 31 Q 111 27 118 30', stroke: '#061c33', strokeWidth: 1.8, fill: 'none', strokeLinecap: 'round' }),
          el('path', { d: 'M 114 53 Q 119 59 126 55', stroke: '#061c33', strokeWidth: 2.4, fill: 'none', strokeLinecap: 'round' }),
